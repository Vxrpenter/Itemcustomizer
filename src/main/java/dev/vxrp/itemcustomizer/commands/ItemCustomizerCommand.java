...
import dev.vxrp.itemcustomizer.menus.itemcustomizer.ItemCustomizerMenu;

public class ItemCustomizerCommand implements CommandExecutor {
    private final Itemcustomizer plugin;
    public ItemCustomizerCommand(dev.vxrp.itemcustomizer.Itemcustomizer itemcustomizer) {
