package dev.vxrp.itemcustomizer.menus.effects.effectstypeonetwo;
...
import dev.vxrp.itemcustomizer.menus.effects.EffectsPickMenu;
...
public class EffectsTypeMenuTwo implements InventoryProvider {
    ...
    public EffectsTypeMenuTwo(dev.vxrp.itemcustomizer.Itemcustomizer itemcustomizer) {
